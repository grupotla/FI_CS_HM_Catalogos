...
class NavierasController extends Controller
{
	...
	{
		return ContactosUsersMenu::ControllerActionsSet2( 14 );
		/*
		return array(
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Navieras']))
		{
			$model->attributes=$_POST['Navieras'];
	...
	{
		$dataProvider=new CActiveDataProvider('Navieras');
	...
	{
		$model=new Navieras('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Navieras']))
			$model->attributes=$_GET['Navieras'];
	...
	{
		$model=Navieras::model()->findByPk($id);
		if($model===null)
	...
	public function actionGenerateExcel()
	{
		...
		$criteria['pagination'] = array('pageSize'=>Navieras::model()->count());
		$model = new CActiveDataProvider('Navieras',$criteria);
    ...
    public function actionGeneratePdf()
	{
        ...
        $html = $this->renderPartial('reportPdf', array('model'=>$model,'title'=>'Navieras'), true);
        $html2pdf->WriteHTML($html);
        $html2pdf->Output('Navieras_'.date('YmdHis').'.pdf');
	}
