...
class Paises extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('conteo_uso',$this->conteo_uso,true);
		$criteria->compare('iso_3166',$this->iso_3166,true);
		...
		$criteria->compare('factor_riesgo',$this->factor_riesgo,true);
		//$criteria->condition = "";		
		//$criteria->order = "";
		
		
				
		Yii::app()->session['Paises_records'] = $criteria;		
