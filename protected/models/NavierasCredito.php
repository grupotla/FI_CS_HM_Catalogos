...
/**
 * This is the model class for table "navieras_credito".
 *
 * The followings are the available columns in table 'navieras_credito':
 * @property integer $id_nav_cred
 ...
 */
class NavierasCredito extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_naviera, id_empresa', 'required'),
			...
			array('id_nav_cred, id_naviera, id_empresa, activo, secuencia, id_usuario, ingreso, id_usuario_modifica, modifica, id_usuario_borrado, borrado, dias, monto, observaciones', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_nav_cred',$this->id_nav_cred);
		$criteria->compare('id_naviera',$this->id_naviera,true);
		...
		Yii::app()->session['NavierasCredito_records'] = $criteria;		
	 ...
	 * @return NavierasCredito the static model class
	 */
