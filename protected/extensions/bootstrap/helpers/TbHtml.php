...
class TbHtml extends CHtml // required in order to access the protected methods in CHtml
{
    ...
    const ICON_COLOR_WHITE = 'icon-white';
    ...
    const ICON_CERTIFICATE = 'icon-certificate';
    ...
    const ICON_CLOUD = 'icon-cloud';
    const ICON_CLOUD_DOWNLOAD = 'icon-cloud-download';
    const ICON_CLOUD_UPLOAD = 'icon-cloud-upload';
    const ICON_COG = 'icon-cog';
    const ICON_COLLAPSE_DOWN = 'icon-collapse-down';
    const ICON_COLLAPSE_UP = 'icon-collapse-up';
    const ICON_COMMENT = 'icon-comment';
    const ICON_COMPRESSED = 'icon-compressed';
    const ICON_COPYRIGHT_MARK = 'icon-copyright-mark';
    const ICON_CREDIT_CARD = 'icon-credit-card';
    const ICON_CUTLERY = 'icon-cutlery';
    const ICON_DASHBOARD = 'icon-dashboard';
    const ICON_DOWNLOAD = 'icon-download';
    const ICON_DOWNLOAD_ALT = 'icon-download-alt';
    const ICON_EARPHONE = 'icon-earphone';
    const ICON_EDIT = 'icon-edit';
    const ICON_EJECT = 'icon-eject';
    const ICON_ENVELOPE = 'icon-envelope';
    const ICON_EURO = 'icon-euro';
    ...
    const ICON_FLASH = 'icon-flash';
    const ICON_FLOPPY_DISK = 'icon-floppy-disk';
    const ICON_FLOPPY_OPEN = 'icon-floppy-open';
    const ICON_FLOPPY_REMOVE = 'icon-floppy-remove';
    const ICON_FLOPPY_SAVE = 'icon-floppy-save';
    const ICON_FLOPPY_SAVED = 'icon-floppy-saved';
    ...
    const ICON_HD_VIDEO = 'icon-hd-video';
    const ICON_HDD = 'icon-hdd';
    const ICON_HEADER = 'icon-header';
    const ICON_HEADPHONES = 'icon-headphones';
    const ICON_HEART = 'icon-heart';
    const ICON_HEART_EMPTY = 'icon-heart-empty';
    ...
    const ICON_LOG_IN = 'icon-log-in';
    const ICON_LOG_OUT = 'icon-log-out';
    ...
    const ICON_SAVED = 'icon-saved';
    const ICON_SCREENSHOT = 'icon-screenshot';
    const ICON_SD_VIDEO = 'icon-sd-video';
    ...
    const ICON_SORT = 'icon-sort';
    const ICON_SORT_BY_ALPHABET = 'icon-sort-by-alphabet';
    const ICON_SORT_BY_ALPHABET_ALT = 'icon-sort-by-alphabet-alt';
    const ICON_SORT_BY_ATTRIBUTES = 'icon-sort-by-attributes';
    const ICON_SORT_BY_ATTRIBUTES_ALT = 'icon-sort-by-attributes-alt';
    const ICON_SORT_BY_ORDER = 'icon-sort-by-order';
    const ICON_SORT_BY_ORDER_ALT = 'icon-sort-by-order-alt';
    const ICON_SOUND_5_1 = 'icon-sound-5-1';
    const ICON_SOUND_6_1 = 'icon-sound-6-1';
    const ICON_SOUND_7_1 = 'icon-sound-7-1';
    const ICON_SOUND_DOLBY = 'icon-sound-dolby';
    const ICON_SOUND_STEREO = 'icon-sound-stereo';
    const ICON_STAR = 'icon-star';
    const ICON_STAR_EMPTY = 'icon-star-empty';
    const ICON_STATS = 'icon-stats';
    const ICON_STEP_BACKWARD = 'icon-step-backward';
    const ICON_STEP_FORWARD = 'icon-step-forward';
    const ICON_STOP = 'icon-stop';
    const ICON_SUBTITLES = 'icon-subtitles';
    ...
    const ICON_TOWER = 'icon-tower';
    const ICON_TRANSFER = 'icon-transfer';
    const ICON_TRASH = 'icon-trash';
    const ICON_TREE_CONIFER = 'icon-tree-conifer';
    const ICON_TREE_DECIDUOUS = 'icon-tree-deciduous';
    const ICON_UNCHECKED = 'icon-unchecked';
    const ICON_UPLOAD = 'icon-upload';
    const ICON_USD = 'icon-usd';
...
EOD;
    ...
    // Icons by icons
    // http://getbootstrap.com/components/#icons
    // --------------------------------------------------
    ...
    {	/*
        if (is_string($icon)) {
            ...
            self::addCssClass(array('icon', $icon), $htmlOptions);
            $color = TbArray::popValue('color', $htmlOptions);
