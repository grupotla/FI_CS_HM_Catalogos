...
class TbPager extends CLinkPager
{
	...
	protected function createPageButton($label, $page, $class, $hidden, $selected)
	{
		...
		if ($hidden || $selected) 
			...
			return CHtml::tag('li', array('class'=>'disabled'), CHtml::link($label, "javascript:return false", array('class'=>'btn btn-small','style'=>'margin:1px;','disabled'=>true)));
		
		else
		
			return CHtml::tag('li', array('class'=>$class), CHtml::link($label, $this->createPageUrl($page),array('class'=>'btn btn-small','style'=>'margin:1px;')));
