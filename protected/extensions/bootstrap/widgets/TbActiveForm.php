...
class TbActiveForm extends CActiveForm
{
    ...
    public function enumDropDownListRow($model, $attribute, $htmlOptions=array())
    {
      	return $this->inputRow(TbInput::TYPE_DROPDOWN, $model, $attribute, ZHtml::enumItem($model,  $attribute), $htmlOptions);
    }

    public function enumRadioButtonListRow($model, $attribute, $htmlOptions=array())
    {
      	return $this->inputRow(TbInput::TYPE_RADIOLIST, $model, $attribute, ZHtml::enumItem($model,  $attribute), $htmlOptions);
    }
        
    public function enumCheckBoxListRow($model, $attribute, $htmlOptions=array())
    {
		return $this->inputRow(TbInput::TYPE_CHECKBOXLIST, $model, $attribute, ZHtml::enumItem($model,  $attribute), $htmlOptions);
    }	
