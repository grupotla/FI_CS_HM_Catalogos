...
<h1><?php echo Yii::t('app','Manage').' '.Yii::t('app','NavierasRepresentantes'); ?> </h1>
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
						...
						'options'=>array(    						
    						'onclick'=>'if ("' . $this->asDialog . '") { crud_frame_adjust($(this).attr("href"),"'.Yii::t("app","Update").' NavierasRepresentantes",2); return false;}',
	                    ),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('navieras-representantes-grid', {
		data: $(this).serialize()
	});
	return false;
});
