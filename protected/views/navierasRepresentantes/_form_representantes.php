<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php //echo "($id_representante)($id_naviera)"?>
	...
	<?php echo $form->dropDownListRow($model,'id_naviera_representante',CHtml::listData(Navieras::model()->findAll(array("condition"=>"parent_id = 2 AND activo = 't'","order"=>"nombre")),'id_naviera','codename'), array('prompt' => '-- Seleccione --', 'disabled'=> 
	...
	<?php echo $form->dropDownListRow($model,'id_naviera',CHtml::listData(Navieras::model()->findAll(array("condition"=>"parent_id <> 2 AND activo = 't'","order"=>"nombre")),'id_naviera','namecode'), array('prompt' => '-- Seleccione --', 'disabled'=> $id_naviera > 0 ? 'true' : '' )); ?>
