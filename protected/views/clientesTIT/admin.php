...
$this->menu=array(
	...
	array('label'=>Yii::t('app','Create').' '.Yii::t('app','ClientesTIT'),'url'=>array('create','button'=>1, 'text'=>Yii::t('app','Create').' '.Yii::t('app','ClientesTIT')), 'icon'=>TbHtml::ICON_FILE . " " . TbHtml::ICON_COLOR_WHITE, 
...
<h1><?php echo Yii::t('app','Manage').' '.Yii::t('app','ClientesTIT'); ?> </h1>
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
						...
						'options'=>array(    						
    						'onclick'=>'if ("' . $this->asDialog . '") { crud_frame_adjust($(this).attr("href"),"'.Yii::t("app","Update").' ClientesTIT",2); return false;}',
	                    ),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('clientes-tit-grid', {
		data: $(this).serialize()
	});
	return false;
});
