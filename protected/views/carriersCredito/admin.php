...
<h1>Manage Carriers Creditos</h1>
		...
		*/
		array(
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
                	 	'url'=>'$this->grid->controller->createUrl("update", array("id"=>$data->primaryKey,"button"=>2, "text" => "Update CarriersCredito"))',
						'options'=>array(    						
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('carriers-credito-grid', {
		data: $(this).serialize()
	});
	return false;
});
