<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	'id'=>'carriers-credito-form',
	'type'=>'horizontal',
	'enableAjaxValidation'=>true,
	'focus'=>array($model,'carrier_id'),
)); ?>
	...
	<?php echo $form->textFieldRow($model,'carrier_id',array('class'=>'span5','data-inputmask-alias'=>"integer", 'readonly'=>true)); ?>
