...
$this->breadcrumbs=array(	
	Yii::t('app','EmpresasPlantillasDatos')=>array('index'),	
	Yii::t('app','Manage'),
);
...
$this->menu=array(
	...
	array('label'=>Yii::t('app','Create').' '.Yii::t('app','EmpresasPlantillasDatos'),'url'=>array('create','button'=>1, 'text'=>Yii::t('app','Create').' '.Yii::t('app','EmpresasPlantillasDatos')), 'icon'=>TbHtml::ICON_FILE . " " . TbHtml::ICON_COLOR_WHITE, 
...
<h1><?php echo Yii::t('app','Manage').' '.Yii::t('app','EmpresasPlantillasDatos'); ?> </h1>
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
						...
						'options'=>array(    						
    						'onclick'=>'if ("' . $this->asDialog . '") { crud_frame_adjust($(this).attr("href"),"'.Yii::t("app","Update").' EmpresasPlantillasDatos",2); return false;}',
	                    ),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('empresas-plantillas-datos-grid', {
		data: $(this).serialize()
	});
	return false;
});
