...
$this->menu=array(
	...
	//array('label'=>Yii::t('app','View').' '.Yii::t('app','EmpresasPlantillasDatos'),'url'=>array('view','id'=>$model->id), 'icon'=>TbHtml::ICON_EYE_OPEN . " " . TbHtml::ICON_COLOR_WHITE),
...
<h1><?php echo Yii::t('app','Update').' '.Yii::t('app','EmpresasPlantillasDatos'); ?>   #<?php echo $model->id; ?></h1>
