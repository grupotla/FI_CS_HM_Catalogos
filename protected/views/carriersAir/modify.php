...
$this->breadcrumbs=array(
	...
	$model->Name=>array('view','id'=>$model->CarrierID),
	Yii::t('app','Update'),
);
...
$this->menu=array(
	...
	array('label'=>Yii::t('app','View').' '.Yii::t('app','CarriersAir'),'url'=>array('view','id'=>$model->CarrierID), 'icon'=>TbHtml::ICON_EYE_OPEN . " " . TbHtml::ICON_COLOR_WHITE),
...
<h1><?php echo Yii::t('app','Modificar').' '.Yii::t('app','CarriersAir'); ?>   #<?php echo $model->CarrierID; ?></h1>
