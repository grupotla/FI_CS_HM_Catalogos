...
<h1><?php echo Yii::t('app','Manage').' '.Yii::t('app','EmpresasPlantillasDocs'); ?> </h1>
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
						...
						'options'=>array(    						
    						'onclick'=>'if ("' . $this->asDialog . '") { crud_frame_adjust($(this).attr("href"),"'.Yii::t("app","Update").' EmpresasPlantillasDocs",2); return false;}',
	                    ),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('empresas-plantillas-docs-grid', {
		data: $(this).serialize()
	});
	return false;
});
