...
<h1><?php echo Yii::t('app','Manage'); ?> Navieras / Representantes</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array('name'=>'id_naviera', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),
		array('name'=>'nombre', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),


		array('name'=>'id_naviera_group', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"',
		'value'=>'isset($data->idNavieraGroup) ? $data->idNavieraGroup->nombre : $data->id_naviera_group'
		),

		array('name'=>'parent_id', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"',
		'value'=>'$data->parent_id == 1 ? "Naviera" : ($data->parent_id == 2 ? "Representante" : "-")'
		),

		array('name'=>'id_pais', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),

		array('name'=>'activo', 'value'=>'$data->activo == 1 ? "on" : "on"', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"','filter'=>array('1'=>'On','0'=>'Off')),

		array('name'=>'tiporegimen', 'value'=>'$data->tiporegimen0->nombre', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),
		
		/*
		array('name'=>'dias', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),
		
		array('name'=>'nit', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),

		array('name'=>'monto', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "on"'),	*/	
	),
)); ?>
