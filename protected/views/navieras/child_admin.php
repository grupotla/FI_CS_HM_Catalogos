		...
		*/
		array(
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
                	 	'url'=>'$this->grid->controller->createUrl("/Navieras/update", array("id"=>$data->primaryKey))',
						'options'=>array(
                ...
                'delete'=>
                    array(                    	
                	 	'url'=>'$this->grid->controller->createUrl("/Navieras/delete", array("id"=>$data->primaryKey))',),                   	
            ),				
		),
	),
)); ?>
