	...
	'columns'=>array(
		...
		array(
            ...
            'buttons'=>array(            	
                'update'=>
                    array(                    	
                	 	'url'=>'$this->grid->controller->createUrl("update", array("id"=>$data->primaryKey,"button"=>2,"text" => "Update ClientesAereo"))',                	 	
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('clientes-aereo-grid', {
		data: $(this).serialize()
	});
	return false;
});
