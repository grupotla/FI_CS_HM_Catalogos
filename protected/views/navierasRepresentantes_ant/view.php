...
$this->menu=array(
	...
	array('label'=>Yii::t('app','Update').' Representantes','url'=>array('update', 'button'=>2, 'text'=>Yii::t('app','Update').' Representantes','id'=>$model->id_naviera), 'icon'=>TbHtml::ICON_PENCIL . " " . TbHtml::ICON_COLOR_WHITE, "visible"=> Yii::app()->session['p']['update'] == 1 ? true : false),
	
	//array('label'=>Yii::t('app','Delete').' Representantes','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->id_naviera),'confirm'=>'¿Esta seguro que quiere borrar este registro?'), 'icon'=>TbHtml::ICON_TRASH . " " . TbHtml::ICON_COLOR_WHITE),
