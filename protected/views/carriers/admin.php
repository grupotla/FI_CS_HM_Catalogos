...
<h1><?php echo Yii::t('app','Manage'); ?> Carriers</h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		//array('name'=>'','value'=> 'isset($data->countries) ? $data->countries->descripcion : $data->countries '),
		array('name'=>'carrier_id', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "off"'),
		array('name'=>'name', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "off"'),
		array('name'=>'countries', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "off"'),
		array('name'=>'carriercode', 'cssClassExpression'=>'$data->activo == 1 ? "on" : "off"'),
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('carriers-grid', {
		data: $(this).serialize()
	});
	return false;
});
