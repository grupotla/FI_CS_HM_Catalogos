<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'name',array('class'=>'span5','maxlength'=>50, 'data-inputmask-alias'=>"address")); ?>

	<?php echo $form->dropDownListRow($model,'countries',CHtml::listData(Paises::model()->findAll(array("condition"=>"","order"=>"")),'codigo','descripcion'), array('class'=>'span5', 'prompt' => '-- Seleccione --')); ?>

	<?php echo $form->textFieldRow($model,'carriercode',array('class'=>'span5', 'data-inputmask-alias'=>"codigo",'maxlength'=>5)); ?>

	<?php echo $form->dropDownListRow($model,'tiporegimen',CHtml::listData(Tiporegimen::model()->findAll(array("condition"=>"","order"=>"")),'numero','nombre'), array('class'=>'span5', 'prompt' => '-- Seleccione --')); ?>
	...
	<?php if (!$model->isNewRecord) $this->renderPartial('/carriersCredito/child_admin',array('model'=>$model)); ?>

	<?php $set_['carriersCredito']['panel'] = ob_get_contents(); ob_end_clean(); ?>
